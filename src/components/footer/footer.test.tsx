...
describe('Footer Component', () => {
  ...
  describe('Rendering and Structure', () => {
    it('should render footer with all components and proper structure', () => {
      ...
      expect(screen.getByText('Feedback')).toHaveAttribute('href', 
      ...
      expect(screen.getByText('- Made By Rafael Dantas Silva')).toHaveAttribute('href', 'https://github.com/RafaelD-S')
    })
    ...
    it('should handle props correctly and render conditionally', () => {
      ...
      render(<Footer 
        calendarMessage="Resetar" 
        feedbackMessage="Opinião:" 
        hasCredits={true} 
      />)
      expect(screen.getByText('Resetar')).toBeInTheDocument()
      expect(screen.getByText(/Opinião:/)).toBeInTheDocument()
      expect(screen.getByText('- Made By Rafael Dantas Silva')).toBeInTheDocument()
    })
  })
