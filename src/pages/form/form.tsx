      ...
      <div className='form'>
        <div className='form__introduction'>
          <h2 className='form__introduction__title'>
            Bem vindo ao{' '}
            <span className='form__introduction__title__accent'>Que Aula?</span>
          </h2>
          <p className='form__introduction__paragraph'>
            Um site desenvolvido por estudantes, para estudantes! Lhe informando
            suas aulas atualizadas diariamente, um calendário relativo a sua
            rotina, um fluxograma editável, e muito mais!
          </p>
          <h4 className='form__warning'>
            Localizações pendentes de atualização para 2025.2
          </h4>
        </div>
        ...
        <div className={submitButtonClasses}>
          ...
          <button
            className='form__submit__button form__submit__generate'
