...
export const mockClassesitems: IClassItem [][] = [
  [
    {
      "name": "INF027",
  ...
  [
    ...
    {
      "name": "INF028",
      "description": "Arquitetura de Computadores e Software Básico",
      "requiredFor": [
        "INF009"
      ],
      "credit": "60 - 3",
  ...
  [
    ...
    {
      "name": "ADM500",
      "description": "Introdução à Administração",
      "requiredFor": [
        "ADM550"
      ],
      "credit": "60 - 4",
  ...
  [
    ...
    {
      "name": "INF017",
      "description": "Redes de Computadores II",
      "requiredFor": [],
      "credit": "60 - 2",
      "state": "default",
      "semester": 4
    ...
    {
      "name": "INF030",
      "description": "Métodos Científicos em Computação",
      "requiredFor": [
        "INF023"
      ],
      "credit": "30 - 2",
  ...
  [
    ...
    {
      "name": "INF020",
      "description": "Sistemas Distribuídos",
      "requiredFor": [],
      "credit": "60 - 3",
      "state": "default",
      "semester": 5
